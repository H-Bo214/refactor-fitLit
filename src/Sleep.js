...
class Sleep {
  ...
  //passing through the sleep data
  ...
  //using chooseWeekDataForAllUsers from user-repo to calculate timeline
  //using isolateUsernameAndRelevantData from user-repo to calculate pertient info for each user
